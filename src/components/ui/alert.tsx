  ...
  "relative w-full rounded-lg border border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-neutral-800 dark:[&>svg]:text-neutral-50 duration-200 ease-out",
  {
    variants: {
      variant: {
        ...
        warning:
          "bg-yellow-200/20 dark:bg-yellow-800/20 border-yellow-500/50 text-yellow-700 dark:border-yellow-500 [&>svg]:text-neutral-950 dark:border-yellow-900/50 dark:text-yellow-500 dark:dark:border-yellow-900 dark:[&>svg]:text-yellow-500",
        information:
